...
st.title("Evidence Selector")
st.markdown("Choose an image, scroll until the end of the page and then click \"Discuss\" to open a new window with an agent that will help you! ")
